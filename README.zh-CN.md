...
### 🌐 多语言支持 (i18n)
- **23 种语言支持**: 包括简体中文、繁体中文、英语、西班牙语、阿拉伯语、法语、波斯语、德语、俄语、马来语、葡萄牙语、意大利语、土耳其语、卡纳达语、泰米尔语、乌尔都语、韩语、印地语、孟加拉语、日语、越南语、泰卢固语、马拉地语
- **自动检测**: 首次加载时自动检测浏览器语言
- **手动切换**: 在设置中选择任意语言
- **持久化**: 语言选择会被保存，并包含在配置导入/导出中
